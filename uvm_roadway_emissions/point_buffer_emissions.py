...
# Full paths to data
vehicle_emissions_path = Path(r"C:\Users\aadame\OneDrive - Environmental Defense Fund - edf.org\Documents\CDHI\uvm_roadway_emissions\data\national_hpms_emissions_all_vehicles.csv") # Emission rates csv
hpms_roadways_path = Path(r"C:\Users\aadame\OneDrive - Environmental Defense Fund - edf.org\Documents\CDHI\uvm_roadway_emissions\data\hpms_all_states_emissions_input.gdb") # HPMS roadways geodatabase
geodata_path = Path(r"C:\Users\aadame\OneDrive - Environmental Defense Fund - edf.org\Documents\CDHI\uvm_roadway_emissions\data\School.shp") # Point data in any vector-based spatial data format
output_dir = Path(r"C:\Users\aadame\OneDrive - Environmental Defense Fund - edf.org\Documents\CDHI\uvm_roadway_emissions\outputs") # Directory to store outputs

# Set options
buffer_radius = 804.7  # Buffer radius in meters - 804.7m is half a mile
state_abbv = "MI"  # Insert your state's abbreviaton, e.g. TX 
...
hpms_roads = gpd.read_file(hpms_roads_path).to_crs(5070).clip(state_geom) # Read in national hpms roadways and clip to the state of interest
...
## Optionally -- output the roads clipped to the state of interest for faster processing in the future
hpms_roads.to_file(output_dir / ("hpms_" + state_abbv + "_roadways.gdb"))
